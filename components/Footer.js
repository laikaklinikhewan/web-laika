const Footer = () => {
  return (
    <footer className="flex bg-black w-full px-16 text-white justify-between m-0">
      <div className="flex w-2/6">
        <svg
          ...
          class="feather feather-map-pin my-auto flex-shrink-0 mr-4"
        >
          <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
          <circle cx="12" cy="10" r="3" />
        </svg>
        <p className="py-4">
          Jalan Tegar Beriman Ruko Cibinong City Center E20, Pakansari,
      ...
      <div className="flex my-auto">
        ...
        >
          <g>
            ...
            <path d="M32,16.1c-8.9,0-15.9,7.2-15.9,15.9c0,8.9,7.2,15.9,15.9,15.9S48,40.9,48,32S40.9,16.1,32,16.1z M32,42.4   c-5.8,0-10.4-4.7-10.4-10.4S26.3,21.6,32,21.6c5.8,0,10.4,4.6,10.4,10.4S37.8,42.4,32,42.4z" />
